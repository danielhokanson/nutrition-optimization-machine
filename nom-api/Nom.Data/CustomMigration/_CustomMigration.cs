        ...
        public static void AddNutrientGuidelines(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { GetNextGuidelineId(), NutrientSaturatedFatId, GoalTypeAdultsAndChildren4PlusId, 1L, null, 20.0m, 20.0m, "DRV for Saturated Fat based on 2,000 kcal diet. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    { GetNextGuidelineId(), NutrientCholesterolId, GoalTypeAdultsAndChildren4PlusId, 8L, null, 300.0m, 300.0m, "DRV for Cholesterol. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientSodiumId, GoalTypeAdultsAndChildren4PlusId, 8L, null, 2300.0m, 2300.0m, "DRV for Sodium. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientAddedSugarsId, GoalTypeAdultsAndChildren4PlusId, 1L, null, 50.0m, 50.0m, "DRV for Added Sugars based on 2,000 kcal diet. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientCholesterolId, GoalTypeInfantsThrough12MonthsId, 8L, null, 300.0m, 300.0m, "DRV for Cholesterol. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientSaturatedFatId, GoalTypeChildren1Through3YearsId, 1L, null, 10.0m, 10.0m, "DRV for Saturated Fat based on 1,000 kcal diet. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    { GetNextGuidelineId(), NutrientCholesterolId, GoalTypeChildren1Through3YearsId, 8L, null, 300.0m, 300.0m, "DRV for Cholesterol. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientSodiumId, GoalTypeChildren1Through3YearsId, 8L, null, 1500.0m, 1500.0m, "DRV for Sodium. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientAddedSugarsId, GoalTypeChildren1Through3YearsId, 1L, null, 25.0m, 25.0m, "DRV for Added Sugars based on 1,000 kcal diet. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientCholesterolId, GoalTypePregnantAndLactatingWomenId, 8L, null, 300.0m, 300.0m, "DRV for Cholesterol. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientSodiumId, GoalTypePregnantAndLactatingWomenId, 8L, null, 2300.0m, 2300.0m, "DRV for Sodium. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
                    ...
                    { GetNextGuidelineId(), NutrientAddedSugarsId, GoalTypePregnantAndLactatingWomenId, 1L, null, 50.0m, 50.0m, "DRV for Added Sugars based on 2,000 kcal diet. MaxAmount = UL.", DateTime.UtcNow, SystemPersonId },
