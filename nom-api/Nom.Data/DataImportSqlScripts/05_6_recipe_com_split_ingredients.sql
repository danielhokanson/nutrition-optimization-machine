...
BEGIN
    ...
    -- This function is defined inside the DO block to ensure it's re-created with each run,
    -- and to ensure it has access to the latest schema if columns were just added.
    ...
    DECLARE
        ...
        -- These variables are declared here in the main DECLARE section of the function.
        -- There should NOT be another 'DECLARE' keyword within the function's BEGIN...END block.
        temp_sub_parts TEXT[] := '{}';
        sub_part TEXT;
    BEGIN
        ...
        -- Removed the inner DECLARE keyword. This is now just a nested BEGIN block.
