...
namespace Nom.Api.Core
{
    ...
    public abstract class BaseCacheService : ICacheService
    {
        ...
        protected readonly ConcurrentDictionary<string, CacheEntry> _cache;
        protected readonly CacheStatistics _statistics;

        protected BaseCacheService(ILogger<BaseCacheService> logger, IOptions<CacheOptions> options)
        {
