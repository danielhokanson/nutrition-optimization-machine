// File: Nom.Api/_Abstractions/_Core/IBaseOrchestrationService.cs
...
namespace Nom.Api.Core
{
    ...
    public interface IBaseOrchestrationService<TEntity, TCreateModel, TUpdateModel, TResponseModel, TId>
        where TEntity : class
