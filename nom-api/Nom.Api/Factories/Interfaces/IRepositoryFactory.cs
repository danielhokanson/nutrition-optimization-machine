// File: Nom.Api/_Abstractions/_Factories/IRepositoryFactory.cs
...
namespace Nom.Api.Factories.Interfaces
{
    ...
    public interface IRepositoryFactory
    {
        ...
        IBaseRepository<TEntity, TId> CreateRepository<TEntity, TId>()
            where TEntity : class
            where TId : struct;
        ...
        IReadOnlyRepository<TEntity, TId> CreateReadOnlyRepository<TEntity, TId>()
            where TEntity : class
            where TId : struct;
        ...
        /// <returns>A repository instance</returns>
        IBaseRepository<TEntity, TId> CreateRepository<TEntity, TId>(RepositoryFactoryOptions options)
            where TEntity : class
            where TId : struct;
        ...
        RepositoryFactoryStatistics GetStatistics();
    }
}