// File: Nom.Api/_Abstractions/_DI/ServiceRegistrar.cs
...
namespace Nom.Api.DI
{
    ...
    public class ServiceRegistrar : IServiceRegistrar
    {
        ...
        public ServiceRegistrar(IServiceCollection services, ILogger<ServiceRegistrar> logger)
        {
        ...
        public void RegisterWithOptions<TService, TImplementation>(ServiceRegistrationOptions options)
            where TService : class
            where TImplementation : class, TService
        {
            try
        ...
        public ServiceRegistrationValidationResult ValidateRegistrations()
        {
