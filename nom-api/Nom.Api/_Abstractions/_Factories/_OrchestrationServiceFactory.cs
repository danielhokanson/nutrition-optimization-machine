// File: Nom.Api/_Abstractions/_Factories/_OrchestrationServiceFactory.cs
...
namespace Nom.Api._Abstractions._Factories
{
    ...
    /// </summary>
    public class _OrchestrationServiceFactory : _IOrchestrationServiceFactory
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<_OrchestrationServiceFactory> _logger;
        private readonly ConcurrentDictionary<Type, _ServiceRegistrationInfo> _serviceRegistrations;
        private readonly ConcurrentDictionary<Type, object> _serviceCache;
        private readonly _OrchestrationServiceFactoryOptions _options;

        public _OrchestrationServiceFactory(
            IServiceProvider serviceProvider,
            ILogger<_OrchestrationServiceFactory> logger,
            _OrchestrationServiceFactoryOptions? options = null)
        {
            _serviceProvider = serviceProvider ?? throw new ArgumentNullException(nameof(serviceProvider));
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _options = options ?? new _OrchestrationServiceFactoryOptions();
            _serviceRegistrations = new ConcurrentDictionary<Type, _ServiceRegistrationInfo>();
        ...
        public _IBaseOrchestrationService<TEntity, TCreateModel, TUpdateModel, TResponseModel, TId> 
            ...
            where TId : struct
        {
            try
            {
                ...
                var baseServiceType = typeof(_BaseOrchestrationService<,,,,>).MakeGenericType(
                ...
                return (_IBaseOrchestrationService<TEntity, TCreateModel, TUpdateModel, TResponseModel, TId>)service;
            }
            catch (Exception ex)
            {
        ...
        public _IReadOnlyOrchestrationService<TEntity, TResponseModel, TId> 
            ...
            where TId : struct
        {
            try
            {
                ...
                var readOnlyServiceType = typeof(_ReadOnlyOrchestrationService<,,>).MakeGenericType(
                ...
                return (_IReadOnlyOrchestrationService<TEntity, TResponseModel, TId>)service;
            }
            catch (Exception ex)
            {
            ...
            where TImplementation : class, TService
        {
            try
            {
                ...
                var registrationInfo = new _ServiceRegistrationInfo
                {
        ...
        public _ServiceRegistrationInfo? GetRegistrationInfo(Type serviceType)
        {
    ...
    public class _ReadOnlyOrchestrationService<TEntity, TResponseModel, TId> 
        ...
        where TId : struct
    {
        ...
        public _ReadOnlyOrchestrationService(
