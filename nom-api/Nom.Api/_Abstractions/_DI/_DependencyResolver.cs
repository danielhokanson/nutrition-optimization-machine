// File: Nom.Api/_Abstractions/_DI/_DependencyResolver.cs
...
namespace Nom.Api._Abstractions._DI
{
    ...
    /// </summary>
    public class _DependencyResolver : _IDependencyResolver
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<_DependencyResolver> _logger;
        ...
        public _DependencyResolver(IServiceProvider serviceProvider, ILogger<_DependencyResolver> logger)
        {
        ...
        public _IDependencyResolver CreateScope()
        {
            try
            {
                var scope = _serviceProvider.CreateScope();
                var resolver = new _DependencyResolver(scope.ServiceProvider, _logger);
        ...
        public _IDependencyResolver GetCurrentScope()
        {
            return this;
        }

        public _DependencyResolutionValidationResult ValidateResolution()
        {
            var result = new _DependencyResolutionValidationResult
            {
                IsValid = true
            };
        ...
        public _DependencyResolutionStatistics GetStatistics()
        {
            lock (_statisticsLock)
            {
                ...
                return new _DependencyResolutionStatistics
                {
