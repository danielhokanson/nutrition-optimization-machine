// File: Nom.Api/_Abstractions/_Core/_ICacheService.cs
...
namespace Nom.Api._Abstractions._Core
{
    ...
    /// </summary>
    public interface _ICacheService
    {
        /// <summary>
        ...
        Task<_CacheStatistics> GetStatisticsAsync();
