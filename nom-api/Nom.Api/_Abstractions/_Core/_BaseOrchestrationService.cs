// File: Nom.Api/_Abstractions/_Core/_BaseOrchestrationService.cs
...
namespace Nom.Api._Abstractions._Core
{
    ...
    public abstract class _BaseOrchestrationService<TEntity, TCreateModel, TUpdateModel, TResponseModel, TId> 
        ...
        where TId : struct
    {
        ...
        protected _BaseOrchestrationService(
