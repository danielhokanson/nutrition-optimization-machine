...
export class OnboardingWorkflowComponent implements OnInit, OnDestroy {
  ...
  private initializeWorkflowPosition(stepId: string | null): void {
    ...
    if (foundIndex !== -1) {
      this.currentStepIndex.set(foundIndex);
    } else {
  ...
  private nextStepInternal(): void {
    ...
    if (
      ...
      this.currentStepIndex.set(healthAttributesStepIndex);
    ...
    if (
      ...
      this.currentStepIndex.set(summaryStepIndex);
      this.navigateToStep(this.workflowSteps[this.currentStepIndex()].id);
      return;
    }
    ...
    if (
      ...
      if (
        ...
        this.currentStepIndex.set(firstRestrictionStepIndex);
        this.navigateToStep(this.workflowSteps[this.currentStepIndex()].id);
        return;
    ...
    this.currentStepIndex.set(nextStepIndexCandidate);
    this.navigateToStep(this.workflowSteps[this.currentStepIndex()].id);
  }
  ...
  previousStep(): void {
    ...
    if (
      ...
      this.currentStepIndex.set(this.additionalParticipantsStepIndex);
      this.navigateToStep(this.workflowSteps[this.currentStepIndex()].id);
      return;
    }
    ...
    if (this.currentStep?.id === 'applyIndividualPreferences') {
      this.currentStepIndex.set(this.lastRestrictionStepIndex);
      this.navigateToStep(this.workflowSteps[this.currentStepIndex()].id);
      return;
    }
    ...
    if (
      ...
      if (this.currentStepIndex() === this.firstRestrictionStepIndex) {
        ...
        if (
          ...
          this.currentStepIndex.set(this.restrictionScopeStepIndex);
        }
        this.navigateToStep(this.workflowSteps[this.currentStepIndex()].id);
        return;
      } else {
    ...
    if (this.currentStepIndex() === this.healthAttributesStepIndex) {
      if (this.currentHealthAttributePersonIndex > 0) {
        ...
        if (this.onboardingData.planInvitationCode) {
          this.currentStepIndex.set(this.invitationCodeStepIndex);
        } else {
          this.currentStepIndex.set(this.additionalParticipantsStepIndex);
        }
        this.navigateToStep(this.workflowSteps[this.currentStepIndex()].id);
